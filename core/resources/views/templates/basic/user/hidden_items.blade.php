    ...
    <div class="row justify-content-center gy-3">
        <div class="col-12">
            <div class="d-flex justify-content-between flex-wrap align-items-center">
                ...
                <div class="sort-by">
                    <select name="status" id="status" class="form--control select2" data-minimum-results-for-search="-1">
                        <option value="">@lang('All')</option>
                        <option @selected($status != null && $status == Status::PRODUCT_PENDING) value="{{ Status::PRODUCT_PENDING }}">@lang('Pending')
                        </option>
                        <option @selected($status == Status::PRODUCT_SOFT_REJECTED) value="{{ Status::PRODUCT_SOFT_REJECTED }}">@lang('Soft Rejected')
                        </option>
                            ...
                            <div class="product-response-info border-0">
                                ...
                                <div class="product-response-info__content">
                                    ...
                                    <div class="d-flex mt-2 gap-2 flex-wrap align-items-center">
                                        <a href="{{ route('user.product.edit', $product->slug) }}" class="text--base">
                                            <i class="la la-edit"></i> @lang('Edit')
                                        </a>
                                        <a href="{{ route('user.product.activities', $product->slug) }}"
                                            class="text--info ">
