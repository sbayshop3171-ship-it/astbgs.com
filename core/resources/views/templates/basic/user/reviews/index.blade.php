    ...
    <div class="row gy-3">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <h6 class="mb-0">@lang('All Reviews')</h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="button--group d-flex justify-content-end gap-2">
                                                    <button class="btn btn-sm btn-outline--primary btn--sm view-btn"
                                                    ...
                                                    <a href="{{ route('product.reviews', ['slug' => $review->product->slug, 'review_id' => $review->id]) }}"
                                                        class="btn btn--sm btn-outline--base " target="_blank">
