@php
    $user = $author;
    $currentLevel = $user->is_author ? $user->currentAuthorLevel->first() : null;
@endphp

<div class="row gy-3">
    <div class="col-lg-3 col-sm-6">
        <div class="dashboard-widget">
            <span class="dashboard-widget__icon--big"><i class="las la-wallet"></i></span>
            <h6 class="dashboard-widget__title">@lang('Wallet Balance')</h6>
            <div class="dashboard-widget__content">
                <span class="dashboard-widget__icon"><i class="las la-wallet"></i></span>
                <div class="dashboard-widget__info">
                    <h5 class="dashboard-widget__amount">{{ showAmount($user->wallet_balance ?? 0) }}</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    @if ($user->is_author)
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="dashboard-widget">
                ...
                <h6 class="dashboard-widget__title">@lang('Earning Balance')</h6>
                <div class="dashboard-widget__content">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="dashboard-widget">
                ...
                <div class="dashboard-widget__content">
                    ...
                    <div class="dashboard-widget__info">
                        <h5 class="dashboard-widget__amount">{{ showAmount($totalWithdrawals) }}</h5>
                    </div>
                </div>
            </div>
        </div>
