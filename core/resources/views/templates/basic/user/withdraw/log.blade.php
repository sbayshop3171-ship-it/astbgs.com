            ...
            <div class="col-12">
                <div class="d-flex justify-content-between flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-2 align-items-center flex-wrap">
                        <x-search-form inputClass="form-control form--control search" btn="btn--base btn--sm" placeholder="Search by transactions" />
                        <a href="{{ route('user.withdraw') }}" class="btn btn-outline--base btn--md"><i class="las la-plus"></i> @lang('New Withdraw')</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-12">
                                ...
                                <tbody>
                                    @forelse($withdraws as $withdraw)
                                        <tr>
                                            ...
                                            <td class="text-end text-lg-center">
                                                <div>
                                                    {{ showAmount($withdraw->amount) }} - <span class="text-danger" title="@lang('charge')">{{ showAmount($withdraw->charge) }}
                                                    </span>
                                                    <br>
