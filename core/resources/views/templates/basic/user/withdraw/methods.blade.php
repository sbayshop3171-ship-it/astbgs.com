...
@section('content')
    <div class="row justify-content-center">
        <div class="col-lg-9">
            @if ($withdrawMethod->isEmpty())
                <div class="alert alert-info">
                    @lang('No withdrawal method is available right now. Please add at least one withdrawal method from the admin panel.')
                </div>
            @endif
                                ...
                                @foreach ($withdrawMethod as $data)
                                    <label for="{{ titleToKey($data->name) }}"
                                        ...
                                        <input class="payment-item__radio gateway-input" id="{{ titleToKey($data->name) }}"
                                            hidden data-gateway='@php echo json_encode($data) @endphp' type="radio"
                        ...
                        <div class="col-lg-6">
                            <div class="payment-system-list p-3">
                                <div class="deposit-info">
                                    ...
                                    <div class="deposit-info__input withdraw-input">
                                        <div class="deposit-info__input-group input-group">
                                            <span class="deposit-info__input-group-text">{{ gs('cur_sym') }}</span>
                                            <input type="number" 
                                                class="form-control form--control withdraw-input amount" name="amount"
...
@push('style')
    <style>
        ...
        .withdraw-input .deposit-info__input-group-text {
            background: #ddd;
            height: 100%;
            padding: 7px 14px;
