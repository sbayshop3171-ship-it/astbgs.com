                    ...
                    <form action="{{ route('ticket.store') }}" class="disableSubmission" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="priority" class="select form--control  select2" data-minimum-results-for-search="-1" required>
                    ...
                    <div class="col-lg-4 col-md-12 removeFileInput">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <button type="button" class="input-group-text text-white bg--danger border-0 removeFile "><i class="las la-times"></i></button>
                            </div>
                        </div>
                    </div>
                `)
