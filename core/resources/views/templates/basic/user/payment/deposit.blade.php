        ...
        <div class="row justify-content-center">
            <div class="col-xxl-9 col-xl-10 col-lg-11">
                ...
                @if (isset($plan) && userActivePlan())
                    ...
                    @endphp
                    <h5> @lang("Your are currently using ':plan - :duration' plan", ['plan' => $planName, 'duration' => $durationText])</h5>
                @endif
                            ...
                            <div class="col-md-6">
                                <div class="payment-system-list p-3">
                                    ...
                                    <div class="info-text pt-2">
                                        <p class="text fs-14">@lang('Ensuring your payment completed safely through our secure payment gateways with world-class payment options.')</p>
                                    </div>
                                </div>
                            </div>
                        </div>
