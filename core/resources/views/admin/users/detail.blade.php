        ...
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.product.all', $user->id) }}" title="Items"
                        icon="las la-box" value="{{ $user->products_count }}" bg="3" type="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.review.index', $user->id) }}" title="Reviews"
                        icon="las la-star" value="{{ $user->reviews_count }}" bg="18" type="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.comment.index', $user->id) }}" icon="las la-comment"
                        title="Comments" value="{{ $user->comments_count }}" bg="10" type="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7"
                        link="{{ route('admin.report.download.log', ['product_id' => 0, 'user_id' => $user->id]) }}"
                        icon="la la-sellsy" title="Download Items" value="{{ $user->download_log_count }}" bg="12"
                        type="2" />
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.deposit.list', $user->id) }}" title="Payments"
