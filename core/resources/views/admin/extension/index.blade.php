                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button--group">
                                            <button type="button" class="btn btn-sm btn-outline--primary mb-2 editBtn"
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline--dark mb-2 helpBtn"
                                            ...
                                            @if($extension->status == Status::DISABLE)
                                                <button type="button"
                                                        class="btn btn-sm btn-outline--success mb-2 confirmationBtn"
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-md-12 control-label fw-bold">@lang('Item')</label>
                            <div class="col-md-12">
