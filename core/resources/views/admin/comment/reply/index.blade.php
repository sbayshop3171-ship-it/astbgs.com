                            ...
                            <tbody>
                                @forelse($replies as $reply)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-bold">{{ __($reply?->user?->fullname) }}</span>
                                            <br>
                                            <span class="small"><a
                                                    href="{{ route('admin.users.detail', $reply->user_id) }}"><span>@</span>{{ $reply?->user?->username }}</a></span>
                                        </td>
                                        <td>{{ __($reply->text) }}</td>
...
@push('breadcrumb-plugins')
    <x-search-form placeholder="Search by reply text, username, product title" />
@endpush
