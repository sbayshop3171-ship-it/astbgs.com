                            ...
                            <tbody>
                                @forelse($logs as $log)
                                    <tr>
                                        <td>
                                            <div class="user d-flex">
                                                <div class="thumb me-2">
                                                    <img src="{{ getImage(getFilePath('productThumbnail') . '/' . productFilePath($log->product, 'thumbnail')) }}"
                                        ...
                                        <td>
                                            <span class="fw-bold">{{ __($log->product?->author?->fullname) }}</span>
                                            <br>
                                            <span>
                                                <a href="{{ route('admin.users.detail', $log->product->author->id) }}"><span>@</span>{{ $log->product->author->username }}</a>
                                            </span>
                                        </td>
                                        <td>
