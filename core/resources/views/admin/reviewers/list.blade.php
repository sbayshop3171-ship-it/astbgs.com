                            ...
                            <tbody>
                                @forelse($reviewers as $reviewer)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge--success mb-2">{{ $reviewer->approved_products_count }}</span>
                                            <br>
                                        ...
                                        <td data-label="Action">
                                            <div class="button--group">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <button class="dropdown-item subcategories-btn"
                                                        data-id="{{ $reviewer->id }}"
                                                    ...
                                                    @if ($reviewer->status == Status::USER_ACTIVE)
                                                        <button type="button" class="dropdown-item reviewerStatus"
                                                            data-status="{{ $reviewer->status }}"
                                                            data-reason="{{ $reviewer->ban_reason }}"
                                                            data-id="{{ $reviewer->id }}">
                                                    ...
                                                    <a href="{{ route('admin.reviewer.login', $reviewer->id) }}"
                                                        target="_blank" class="dropdown-item ">
                                                        <i class="las la-sign-in-alt"></i>
                                                            @lang('Login')
                                                    </a>
                                                    <a href="{{ route('admin.reviewer.products.approved', $reviewer->id) }}"
                                                        target="_blank" class="dropdown-item ">
            ...
            <div class="modal-content">
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn--dark btn--danger"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input name="password" type="text" class="form-control" required
                                            id="password">
                                        <button class="input-group-text pass-generate"
