...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        $request->validate([
            ...
            'file_server'         => 'required|in:' . Status::SERVER_CURRENT . ',' . Status::SERVER_FTP . ',' . Status::SERVER_WASABI . ',' . Status::SERVER_DIGITAL_OCEAN . ',' . Status::SERVER_BACKBLAZE,
            'referral_fixed'      => 'required|numeric',
            'referral_percentage' => 'required|numeric',
            'min_reviews'         => 'required|numeric',
            'trending_count'      => 'required|numeric',
        ]);
        ...
        $general->referral_fixed      = $request->referral_fixed;
        $general->referral_percentage = $request->referral_percentage;
        $general->min_reviews         = $request->min_reviews;
        $general->trending_count      = $request->trending_count;
        $general->save();
    ...
    public function systemConfigurationSubmit(Request $request)
    {
        ...
        $general->changelog       = $request->changelog ? Status::ENABLE : Status::DISABLE;
        $general->comment_disable = $request->comment_disable ? Status::ENABLE : Status::DISABLE;
        $general->free_item       = $request->free_item ? Status::ENABLE : Status::DISABLE;
        $general->advertisement   = $request->advertisement ? Status::ENABLE : Status::DISABLE;
        $general->save();
